...
test(basic_12):- valid_generator(string).
...
test(composite_8):- valid_generator(string(1,2)).
...
test(composite_8):- \+ valid_generator(string(2,1)).
test(composite_9):- \+ valid_generator(string(1,-2)).
